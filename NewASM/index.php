        ...
        <main class="main">
            ...
            <div id="product-container" class="container">
                <div class="toolbox toolbox-filter">
                    <div class="toolbox-right">
                        <ul class="nav-filter product-filter">
                            ...
                            <li><a href="./Soft_By_Category.php?Soft=Loa">Loa</a></li>
                        </ul>
                ...
                <div class="products-container" data-layout="fitRows">
                    <?
                    if (isset($connection)) {
                        $statement = $connection->prepare("SELECT * FROM products LIMIT 0,9");
                        $statement->execute([]);
                            ...
                            <div class="product product-4">
                                ...
                                <div class="product-body">
                                    ...
                                    <div class="product-action">
                                        <?
                                        if ($Product['status'] == 1) { ?>
                                            <form action="./Cart.php?index=1&action=add&productIdGet=<?= $Product['productId'] ?>" method="POST">
                                                <input type="hidden" value="1" name="Quantity[<?= $Product['productId'] ?>]">
                                                <button type="submit" class="btn-product btn-cart" style="border: none;"><span>add to cart</span><i class="icon-long-arrow-right"></i></button>
                                            </form>
                                        <? }
                                        ?>
