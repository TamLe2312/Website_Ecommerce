        ...
        <main class="main">
            ...
            <div class="page-content">
                <div class="container">
                    ...
                    if (!empty($_SESSION['currentUser'])) {
                        if ($user['role'] == 1) { ?>
                            <form id="form-cat" action="./Categories.php" method="POST" class="form">
                                <input type="hidden" name="id" id="id" />
                                <input type="text" id="CID" class="form-control" name="CID" placeholder="Enter Id Category" /><br />
                                <input type="text" id="CN" class="form-control" name="CN" placeholder="Enter Name Category" /><br />
                    ...
                    <table class="table table-wishlist table-mobile">
                        ...
                        <tbody>
                            ...
                            if (isset($connection)) {
                                $start = 0;
                                $rows_per_page = 5;
                                $statement4 = $connection->prepare("SELECT * FROM categories");
                                $statement4->execute([]);
                                ...
                                $statement = $connection->prepare("SELECT * FROM categories LIMIT $start,$rows_per_page");
                                $statement->execute([]);
                            ...
                            foreach ($Categories as $category) { ?>
                                <tr>
                                    ...
                                    <td class="price-col"><?= $category['categoryId'] ?></td>
                                            ...
                                            <td class="action-col">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" onclick="updateCategory('<?= $category['categoryId'] ?>','<?= $category['categoryName'] ?>')">Edit</a>
                                                        <a class="dropdown-item" href="./Delete_Category.php?id=<?= $category['categoryId'] ?>">Delete</a>
                                                    </div>
                                                </div>
                                            </td>
                                    <? }
