                ...
                <div class="container">
                    <div class="products">
                        <div class="row">
                            <?
                            if (isset($connection)) {
                                $statement = $connection->prepare("SELECT * FROM products as P
                                ...
                                <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                                    <div class="product">
                                        <figure class="product-media">
                                            ...
                                            if ($Status == 1) { ?>
                                                <span class="product-label label-sale"><?= $Product['sale'] ?>% off</span>
                                            <? } elseif ($Status == 2) { ?>
                                        ...
                                        <div class="product-body">
                                            ...
                                            <div class="product-price">
                                                ...
                                                ?>
                                                    <span class="new-price"><?= currency_format($NewPrice) ?></span>
